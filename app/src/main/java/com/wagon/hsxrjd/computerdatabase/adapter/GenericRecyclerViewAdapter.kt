 ...
 */
abstract class GenericRecyclerViewAdapter<T : Attribute> : RecyclerView.Adapter<RecyclerAdapterFactory.BaseViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerAdapterFactory.BaseViewHolder {
        return RecyclerAdapterFactory.buildHolder(parent, viewType)
    }
